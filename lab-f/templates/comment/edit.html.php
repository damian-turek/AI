...
$title = "Edit Comments {$comment->getSubject()} ({$comment->getId()})";
$bodyClass = "comment-edit";

ob_start(); ?>
    <!-- /app/templates/comment/edit.php -->
    <h1>Edit Comment <?= $comment->getSubject() ?> (<?= $comment->getId() ?>)</h1>
